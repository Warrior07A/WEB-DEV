...
const client: Client = new Client({
  connectionString:
    "postgresql://neondb_owner:npg_e4MNhcY2mKZX@ep-sweet-sunset-ahg4p0j6-pooler.c-3.us-east-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require",
});
...
app.post("/api/auth/signup", async (req: Request, res: Response) => {
  ...
  RETURNING *
  `;
  const adduser = await client.query(query);
