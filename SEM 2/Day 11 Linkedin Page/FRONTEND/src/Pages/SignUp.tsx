...
export function SignUp() {
    ...
    return (
        <div style = {{backgroundColor : "#F3F2F0" , height : "100vh"}}>
            <div style={{ height: "100%", display: "flex", justifyContent: "center", alignItems: "center"  }}>
                <div style = {{display : "flex" , flexDirection : "column"}}>
                    <div style={{ width: "7.5rem", height: "2rem", paddingLeft: "12rem", paddingTop: "-0.3rem" }}>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 84 21" preserveAspectRatio="xMinYMin meet" version="1.1" focusable="false" aria-busy="false">
                    ...
                    <div style={{ height: "30rem", justifyContent: "center" , display : "flex" , flexDirection : "column", alignItems : "center"}}>
                        <div>
